...
const unsigned char xgpro_open_devices_pattern1[] = {
                                                     ...
                                                     0x40, 0x6A, 0x03, 0x6A, 0x00, 0x6A, 0x03, 0x68, 0x00, 0x00, 0x00, 0xC0, 0x68};

const unsigned char xgpro_open_devices_pattern2[] = {
                                                     0x6A, 0x00, 0x68, 0x80, 0x00, 0x00, 0x40, 0x6A,
                                                     0x03, 0x6A, 0x00, 0x6A, 0x03, 0x68, 0x00, 0x00, 0x00, 0xC0, 0x51};
...
BOOL patch_xgpro() {
	...
	void *p_od1 = memmem(BaseAddress + NtHeader->OptionalHeader.BaseOfCode,
	...
	void *p_od2 = memmem(BaseAddress + NtHeader->OptionalHeader.BaseOfCode,
	...
	if(p_od1) {
		...
		p_closedevices =
				(void *)(*(int *)((unsigned char *)p_opendevices + 8)) +
